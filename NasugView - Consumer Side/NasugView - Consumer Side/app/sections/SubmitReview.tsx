...
export default function SubmitReviewNo() {
  ...
  const backListenerRef = useRef<any>(null); // ref to store listener

  // confirm when pressing back
  useEffect(() => {
  ...
  // when pressing OK on thank-you modal
  const handleThankYouOkay = () => {
    // remove listener temporarily to prevent discard modal
    if (backListenerRef.current) {
      backListenerRef.current(); // unsubscribe beforeRemove
  ...
  return (
    <>
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.heading}>What do you recommend about {name}?</Text>
        ...
        <View style={styles.bottomRow}>
          ...
          {loading ? (
            ...
            <TouchableOpacity style={styles.roundSubmitButton} onPress={submitReview}>
              <Text style={styles.roundSubmitText}>Share</Text>
            </TouchableOpacity>
          )}
        </View>
      </ScrollView>
